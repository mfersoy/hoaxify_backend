...
import com.hoaxify.exception.message.ApiResponseError;
...
@ControllerAdvice
public class HoaxifyExceptionHandler extends ResponseEntityExceptionHandler {

    Logger logger = LoggerFactory.getLogger(HoaxifyExceptionHandler.class);
